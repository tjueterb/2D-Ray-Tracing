...
SURFACE_SAMPLING = False # Enable surface sampling (default mode)
#------------------
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == KEYDOWN:
            ...
            elif event.key == pygame.K_t and not SURFACE_SAMPLING:
            ...
            # Toggle between demo mode and alternative mode with 'D' key
                ...
                SURFACE_SAMPLING = not SURFACE_SAMPLING
                if SURFACE_SAMPLING:
